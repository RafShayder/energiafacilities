...
def get_save_errors(configyaml: str,configpostgress:str="postgress"): #webindra_energia
    ...
    tablaorigen=general_config['schema'] + "." + general_config['table']
    ...
    if not data.empty:
        ...
        baseexporter.export_dataframe_to_remote(data, conn=condigsfpt, 
            remote_dir=general_config['errorconfig']["remote_dir"],filename="data_errores_web_indra" )
